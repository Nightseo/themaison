			...
			<head>
				<xsl:choose>
					<xsl:when test="kml:kml">
						<title>Emplacements - Plan de site - Maison Du Coloriage</title>
					</xsl:when>
					<xsl:otherwise>
						<title>Sitemap XML - Maison Du Coloriage</title>
					</xsl:otherwise>
				</xsl:choose>
				...
				<xsl:choose>
					<xsl:when test="kml:kml">
						...
						<div id="content">
							...
							<p class="expl">
								<a href="https://www.maisonducoloriage.com/sitemap_index.xml">&#8592; Index du plan de site</a>							</p>
